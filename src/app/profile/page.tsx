        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-10">
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
            ...
            <div className="flex items-center gap-4">
              <div className="w-16 h-16 sm:w-20 sm:h-20 rounded-3xl bg-gradient-to-tr from-blue-700 to-blue-500 text-white font-black text-2xl flex items-center justify-center shadow-lg shadow-blue-500/20 flex-shrink-0">
                {candidateInitials}
              </div>
              <div className="space-y-1">
                <div className="flex items-center gap-2 flex-wrap">
                  ...
                  <span className="text-[10px] font-bold px-2.5 py-0.5 bg-emerald-50 text-emerald-700 border border-emerald-200 rounded-full flex items-center gap-1">
            ...
            <div className="flex items-center gap-3">
              <Link
                href="/quiz"
                className="px-4 py-2.5 bg-blue-600 hover:bg-blue-700 text-white font-bold text-xs rounded-xl transition shadow-md shadow-blue-500/20 flex items-center gap-2 cursor-pointer"
              >
          ...
          {/* Navigation Tabs */}
          <div className="mt-8 flex items-center gap-2 border-b border-slate-200 overflow-x-auto scrollbar-none">
            <button
          ...
          <div className="space-y-6">
            {loadingRegistrations ? (
              ...
              <div className="p-12 text-center bg-white rounded-3xl border border-slate-200 space-y-4">
                ...
                <Link
                  href="/olympiad"
                  className="inline-flex items-center gap-2 px-5 py-2.5 bg-blue-600 hover:bg-blue-700 text-white font-bold text-xs rounded-xl transition shadow-sm cursor-pointer"
                >
              ...
              <div className="grid md:grid-cols-2 gap-6">
                {registrations.map((reg) => (
                  <div
                    ...
                    className="bg-white border-2 border-slate-200 hover:border-blue-500 rounded-3xl p-6 shadow-sm hover:shadow-md transition-all space-y-5 flex flex-col justify-between relative overflow-hidden"
                  >
                    {/* Top Hall Ticket Bar */}
                    <div className="space-y-4">
                      <div className="flex items-center justify-between border-b border-slate-100 pb-3">
                        <div className="flex items-center gap-2">
                          ...
                          <div>
                            ...
                            <h4 className="text-sm font-black text-slate-900">{reg.olympiadTier}</h4>
                          </div>
                        </div>
                        <span className="px-2.5 py-0.5 bg-emerald-50 text-emerald-700 border border-emerald-200 rounded-full text-[10px] font-bold flex items-center gap-1">
                          <CheckCircle2 className="w-3 h-3" /> {reg.status || 'CONFIRMED'}
                        </span>
                      </div>

                      {/* Candidate Roll Number Box */}
                      <div className="bg-slate-50 border border-slate-200/80 rounded-2xl p-4 flex items-center justify-between">
                        <div>
                          <span className="text-[10px] text-slate-400 font-bold uppercase tracking-wider block">
                            Assigned Roll Number / रोल नंबर
                          </span>
                          <p className="text-lg font-mono font-black text-slate-900 tracking-widest mt-0.5">
                            {reg.rollNo}
                          </p>
                        </div>
                      ...
                      <div className="grid grid-cols-2 gap-3 text-xs">
                        <div>
                          ...
                          <span className="font-bold text-slate-800">{reg.candidateName}</span>
                        </div>
                        <div>
                          <span className="text-slate-400 block text-[11px]">Assessment Fee:</span>
                          <span className="font-bold text-emerald-600">₹{reg.amount} (Paid Online)</span>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="pt-4 border-t border-slate-100 flex items-center justify-between gap-3">
                      ...
                      <Link
                        href={`/quiz?mode=olympiad&roll=${encodeURIComponent(reg.rollNo)}`}
                        className="px-4 py-2 bg-amber-500 hover:bg-amber-400 text-slate-950 font-black text-xs rounded-xl transition flex items-center gap-1.5 shadow-sm cursor-pointer"
                      >
